...
public class Video {
	...
	public String toString() {
		return "Video [videoId=" + videoId + ", videoTitle=" + videoTitle + ", videoDesc=" + videoDesc + ", videoTime="
				+ videoTime + ", speakerId=" + speakerId + ", courseId=" + courseId + ", videoUrl=" + videoUrl
				+ ", videoImgUrl=" + videoImgUrl + ", videoPlayNum=" + videoPlayNum + ", speaker=" + speaker + "]";
	}
