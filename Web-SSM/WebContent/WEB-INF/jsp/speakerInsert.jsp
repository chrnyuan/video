     ...
     <div id="box3">
            <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-2"><h3>添加主讲人</h3></div>
                ...
                <div class="box">
                  <form  action="${pageContext.request.contextPath }/speakerInsert.action" method="post">
       				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 姓名&nbsp;&nbsp;<input type="text" name="speakerName" class="box5" 
                  placeholder="主讲人姓名">
                <br><br>
         
                   
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 职位&nbsp;&nbsp;<input type="text" name="speakerJob" class="box5" 
                   placeholder="主讲人职位">
                <br><br>
                	头像地址&nbsp;&nbsp;<input type="text" name="speakerHeadUrl" class="box5" 
                    placeholder="主讲人头像">
                <br><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 简介&nbsp;&nbsp;<input type="text" name="speakerDesc" 
                class="box5" placeholder="主讲人简介">
                 <br><br>    
