     ...
     <div id="box3">
            <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-2"><h3>添加课程</h3></div>
                ...
                <div class="box">
                   <form action="courseInsertA.action" method="post">
            所属学科&emsp;<select name="subjectId" class="box5" placeholder="请选择所属学科">
                   ...
                   <br><br>
                 &emsp;&emsp;标题&emsp;<input type="text" name="courseTitle" class="box5" placeholder="课程标题">
                <br><br>
                &emsp;&emsp;简介&emsp;<input type="text" name="courseDesc"  class="box4">
                 <br><br>    
