    ...
    <div class="container">
        ...
        <div class="row">
            <div style="color:lightyellow">
                ...
                <div class="col-xs-6"></div>
                <div class="col-xs-2"><img src="${user.userImgurl}" style="width:40px;height:30px;">
...
<div class="con">
    ...
    <div class="big">
      	<p> 昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：${user.userNickname}</p>
       	<p>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：${user.userSex}</p>
        <p>生&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日：${user.userBithday}</p>
       	<p>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：${user.userEmail}</p>
        <p>所&nbsp;在&nbsp;地：${user.userAddress}</p>
