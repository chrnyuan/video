...
<body>
	...
	<form action="adminLogin.action" method="post">
		<h1 id="a">&emsp;&emsp;管理员登录</h1>
	账号：<input type="text" name ="adminName"  class="t" id="adminName" >
		<br><i id="i" style="color:red;"></i><br>
	密码：<input type="password" name ="adminPassword"  class="t" >
		<i>${error}</i><br><br>
		<input type="submit" value="登录"  class="s">
	</form><br>
	<a href="${pageContext.request.contextPath }/adminRegister.action"><button class="s">注册</button></a>
